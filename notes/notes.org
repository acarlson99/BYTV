...
* TODO [0/5]
  ...
  - [-] Features (from BTTV extension pages) [0/6]
    - [-] Extra emoticons - BetterTTV global and per-channel emotes [3/6]
  ...
  - [ ] Misc
    - [ ] Use JQuery instead of yucky `getElementsByClassName` functions
  - [ ] Deploy [0/2]
